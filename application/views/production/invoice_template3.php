                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-right pr-0 font-weight-bold  text-uppercase">Sub Total</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            ...
                            <tr class="font-weight-boldest">
                                ...
                                <!-- <td class="text-right pt-7">Rp <?= number_format($transaction[''], 2, ',', '.') ?></td> -->
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="font-weight-bolder">
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="text-danger font-size-h3 font-weight-boldest">Rp <?= number_format($transaction['net_total_amount'], 2, ',', '.') ?></td>
                                </tr>
                            </tbody>
                        </table>
                    <?php } ?>
