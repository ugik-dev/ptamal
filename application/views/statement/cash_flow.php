        ...
        <div>
            <table id="1" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <?php
                    echo '<tr><td style="text-align:left;"><h4>&nbsp&nbsp&nbsp Pendapatan Usaha : </h4></td><td class="fr-currency">' . number_format($journals['in_usaha']['value']) . '</td><td></td></tr>';
                    echo '<tr><td style="text-align:left;"><h4>&nbsp&nbsp&nbsp Pendapatan Bank : </h4></td><td class="fr-currency">' . number_format($journals['in_bank']['value']) . '</td><td></td></tr>';
                    echo '<tr><td style="text-align:left;"><h4>&nbsp&nbsp&nbsp Pendapatan Lainnya : </h4></td><td class="fr-currency">' . number_format($journals['in_dll']['value']) . '</td><td></td></tr>';
                    echo '<tr><td style="text-align:left;"><h4>&nbsp&nbsp&nbsp Pengeluaran HPP : </h4></td><td class="fr-currency">' . number_format($journals['out_usaha']['value']) . '</td><td></td></tr>';
                    echo '<tr><td style="text-align:left;"><h4>&nbsp&nbsp&nbsp Pengeluaran Biaya General Administrasi : </h4></td><td class="fr-currency">' . number_format($journals['out_general']['value']) . '</td><td></td></tr>';
                    echo '<tr><td style="text-align:left;"><h4>&nbsp&nbsp&nbsp Pengeluaran Pajak :</h4></td><td class="fr-currency">' . number_format($journals['out_pajak']['value']) . '</td><td></td></tr>';
                    echo '<tr><td style="text-align:left;"><h4><b>&nbsp&nbsp&nbsp TOTAL : </b></h4></td><td></td><td class="fr-currency"> ' . number_format($journals['total']['operasi']) . '</td></tr>';
                    ?>
                    <tr>
                        <td style="text-align:left;">
                    ...
                    <?php
                    echo '<tr><td style="text-align:left;"><h4>&nbsp&nbsp&nbsp Pinjaman Modal : </h4></td><td class="fr-currency">' . number_format($journals['inves_pinjaman']['value']) . '</td><td></td></tr>';
                    echo '<tr><td style="text-align:left;"><h4><b>&nbsp&nbsp&nbsp TOTAL : </b></h4></td><td></td><td class="fr-currency"> ' . number_format($journals['total']['inves']) . '</td></tr>';
                    ?>
                    <tr>
                        <td style="text-align:left;">
                            <h4><b> Kenaikkan Kas
