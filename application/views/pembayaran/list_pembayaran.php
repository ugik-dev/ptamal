<div class="card card-custom position-relative overflow-hidden">
    ...
    <div class="alert alert-custom alert-white" role="alert">
        ...
        $attributes = array('id' => 'pembayaran_form', 'method' => 'get', 'class' => 'form col-lg-12');
        ?>
        <?php echo form_open('pembayaran/history', $attributes); ?>
    ...
    <div class="card card-custom position-relative overflow-hidden" id="<?php echo $pembayarans_Record[$i]['id']; ?>">
                ...
                <div class="col-lg-5">
                    <!-- <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <a type="button" href="<?= base_url('pembayaran/download_word/') . $pembayarans_Record[$i]['id'] ?>" class="btn mr-3 my-1">To KA Akuntansi</a>
                            <a type="button" href="<?= base_url('pembayaran/download_word/') . $pembayarans_Record[$i]['id'] ?>/2" class="btn mr-3 my-1">To Divisi Eksplorasi</a>
                            <a type="button" href="<?= base_url('pembayaran/download/') . $pembayarans_Record[$i]['id'] ?>" class="btn">Invoice PDF</a>
                        </div>
                    </div> -->
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            ...
                            echo  $pembayarans_Record[$i]['agen_id'] ? (' <a class="btn" href="' . base_url() . 'pembayaran/edit/' . $pembayarans_Record[$i]['id'] . '"><i class="fas fa-pencil-alt pull-left"></i> Edit </a>
        ...
        <div class="row">
            <div class="col-lg-9 col-sm-9 col-xs-12">
                ...
                <div class="col-lg-12 col-sm-12 col-xs-12">
                    <b> No Tagihan # <?= str_pad($pembayarans_Record[$i]['id'], 5, '0', STR_PAD_LEFT) ?> </b>
                </div>
            ...
            <div class="col-xs-12">
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        foreach ($pembayarans_Record[$i]['items'] as $item) {
            ...
            <div class="col-lg-12 col-sm-12 col-xs-12">
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <th style="width:50%">FEE <?= floatval($pembayarans_Record[$i]['percent_jasa']) ?>%</th>

                            <td class="text-right">
                                <?php if ($pembayarans_Record[$i]['percent_jasa'] > 0) {
                                    $fee =  ceil(($pembayarans_Record[$i]['percent_jasa'] / 100 * $total));
