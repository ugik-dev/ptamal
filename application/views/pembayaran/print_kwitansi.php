                        ...
                        <tr>
                            ...
                            <td width="60%">
                                ...
                                <table border="0" style="margin-left : 50px" width="400">
                                    ...
                                    if ($transaction['percent_jasa'] > 0) {
                                    ?>
                                        <tr>
                                            <td width="200px" class="value" style="margin-right: 2px;">FEE <?= floatval($transaction['percent_jasa']) ?>%</td>
                                            <td width="10px" class="value" style="margin-right: 1px;">Rp</td>
                                            <td width='' class="value" style="text-align: right; margin-right: 0">- <?= number_format($transaction['percent_jasa'] / 100 * $tot_item, 0, ',', '.') ?></td>
                                        </tr>
                                    <?php
                                        $i++;
                                    }
